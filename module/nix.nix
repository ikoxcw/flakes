{ self, pkgs, inputs, lib, ... }:
{
  ...
  nixpkgs = {
    ...
    overlays = [
      ...
      # (final: prev: {
      #   ikoxcw.rime-ice = prev.ikoxcw.rime-ice.overrideAttrs (finalAttrs: previousAttrs: {
      #     installPhase = ''
      #       mkdir -p $out/share/rime-data
      #       cp -r * $out/share/rime-data/
      #       cp ${pkgs.ikoxcw.fcitx5-pinyin-zhwiki}/share/fcitx5/pinyin/dictionaries/zhwiki.dict $out/share/rime-data/cn_dicts/
      #       cp ${pkgs.ikoxcw.fcitx5-pinyin-moegirl}/share/fcitx5/pinyin/dictionaries/fcitx5-pinyin-moegirl.dict $out/share/rime-data/cn_dicts/
      #
      #     '';
      #   });
      # })
