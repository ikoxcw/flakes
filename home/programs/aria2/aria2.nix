{ user, config, pkgs, ... }:
{
  home.file.".config/aria2c/aria2.conf".text =
    ''
      #
      ...
      # IPv4 DHT 文件路径，默认：/home/${user}/.aria2/dht.dat
      dht-file-path=/home/${user}/.aria2/dht.dat

      # IPv6 DHT 文件路径，默认：/home/${user}/.aria2/dht6.dat
      dht-file-path6=/home/${user}/.aria2/dht6.dat
      ...
      on-download-stop=/home/${user}/.aria2/delete.sh

      # 下载完成后执行的命令
      # 此项未定义则执行 下载停止后执行的命令 (on-download-stop)
      on-download-complete=/home/${user}/.aria2/clean.sh
